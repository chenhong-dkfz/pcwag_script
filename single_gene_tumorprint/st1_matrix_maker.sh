#parameter setting
cohort=$1
source_dir="/omics/groups/OE0436/data/chen/co02/pcawg_2018"
code_dir="/omics/groups/OE0436/data/chen/home/single_gene_tumorprint"
...
#for cohort in ${cohort_list};do
    pid_file="/omics/groups/OE0436/data/chen/co02/pcawg_2018/pid_list/whitelist/${cohort}.txt"
    while read line; do
        mkdir -p ${source_dir}/result/${cohort}/${line}
        
        #echo ${line}
        
        bedtools intersect -a ${roi} -b ${source_dir}/snv_exon/${line}.txt -wao > ${source_dir}/result/${cohort}/${line}/snv_tmp.bed
