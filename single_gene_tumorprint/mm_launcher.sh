...
job_mm=`bsub -o /omics/groups/OE0436/data/chen/log -J matrix_${coh} -W 01:00  /omics/groups/OE0436/data/chen/home/single_gene_tumorprint/st1_matrix_maker.sh ${coh}| cut -d "." -f 1`
