...
#f_pid_rna = open("/omics/groups/OE0436/data/chen/co02/chen/pcawg_2018/regions/tumor_rna_new_uniq.txt","r")
f_pid_rna = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/regions/ta_star2.txt","r")
...
gid = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/regions/gencode.v19.txt","r")
for line in gid:
	line = line.strip("\n")
	el = line.split("\t")
...
zsc = open("/omics/groups/OE0436/data/chen/expression_final_version/zscore/zscore.csv","r")
fo = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/exp_file_star.csv","w")
for line in zsc:
	if line[0] == "#":
		line = line.strip("\n")
		print >>fo,line
...
fin = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/exp_file_star.csv","r")
fout = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/exp_file_ta.csv","w")
...
fin = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/matrix/coding/select/mutation.csv","r")
fo = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/mut1.csv","w")
for line in fin:
	if line[0] == "g":
		line = line.strip("\n")
		line = "#"+line
...
fin = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/mut1.csv","r")
fout = open("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/mut.csv","w")
...
os.remove("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/mut1.csv")
