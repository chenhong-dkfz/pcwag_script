...
snv.table <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/mut.csv",data.table = F)
exp.table <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/result/file_cache/exp_file_ta.csv",data.table = F)
...
#input file III
pid.cohort <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/pid_list/pid.tsv",data.table = F,header = F)
...
#input file IV
list.table <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/regions/pcawg_sample_info_v1.txt",
                    data.table = F)
...
if (ncol(df0)!=0){
  ...
  # input file V
  metas <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/meta.txt",data.table = F,header = F)
...
background_dh <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/backgroud/backs2.txt",data.table = F)
background_gain <- fread("/omics/groups/OE0436/data/chen/co02/pcawg_2018/backgroud/amp_overview_background.txt",data.table = F)
