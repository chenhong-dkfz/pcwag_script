...
code_dir="/home/hongc/PhD/promoters/code"
roi=/home/hongc/PhD/promoters/code/promoter_hg.txt
...
mkdir -p ${source_dir}/result/matrix/promoter
...
#for cohort in ${cohort_list};do
    ...
    while read line; do
        ...
        bedtools intersect -a ${roi} -b ${source_dir}/snv_mnv_del_position/${line}.txt -wao > ${source_dir}/result/${cohort}/${line}/snv_tmp.bed
    ...
    paste ${roi} `ls  ${source_dir}/result/${cohort}/*/roi.bed` > ${source_dir}/result/matrix/promoter/${cohort}2.bed
    sort -k4,4 ${source_dir}/result/matrix/promoter/${cohort}2.bed > ${source_dir}/result/matrix/promoter/${cohort}.bed
