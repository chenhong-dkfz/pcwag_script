...
setwd("/home/hongc/test/result_subcohort3")
...
for(mut in mutss){
  setwd(paste0("/home/hongc/test/result_subcohort3/",mut))
  require(data.table)
  FileNameExport <- paste0("/home/hongc/test/result_subcohort3/",mut)
  ...
  cli::cat_line("Writing ", length(datalist), " tables to file 'ALC1_", FileNameExport, ".txt'.")
  write_xlsx(x=datalist, path=paste0("/home/hongc/test/result_101219/ALC1/ALC1_",mut,".xlsx"), col_names=TRUE)
