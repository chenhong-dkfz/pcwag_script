...
setwd("/abi/data")
data <- fread(paste0("/abi/data/chen/project_august/mutation25/",gene.name,"/",muts),data.table=F)
...
#   inter <- a[[4]]
#   ndel <- total - mut1
#   p.value <- comet_exact_test(c(total,mut1,mut2,ndel))
# }
# 
# 
...
save(mut0,file=paste0("/abi/data/chen/project_august/mutation25/result/",gene.name,"/",muts))