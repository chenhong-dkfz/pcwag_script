...
write.table(pvals_chd1l,file="/abi/data/chen/project_august/mutation25/cohortwise/full2/pten_hyper.txt",
            col.names = T, row.names = F, quote = F, sep = "\t")
write.table(pvals_f,file="/abi/data/chen/project_august/mutation25/cohortwise/full2/pten_fisher.txt",
            col.names = T, row.names = F, quote = F, sep = "\t")
write.table(ests_f,file="/abi/data/chen/project_august/mutation25/cohortwise/full2/pten_oddsratio.txt",
            col.names = T, row.names = F, quote = F, sep = "\t")
